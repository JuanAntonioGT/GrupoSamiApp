...
fun descripcionDos(activity: FormularioActivity, servicio: Servicio) {
            ...
            if (it.size > 0) {
                ...
                for (formulario in listadoFormulario) {
                    ...
                    boton.setOnClickListener {
                        servicio.descripcionDos = boton.text.toString()
                ...
                boton.setOnClickListener {
                    servicio.descripcionDos = editText.text.toString()
